<div class="card card-custom bg-light-success card-stretch gutter-b">
    ...
    <div class="card-body">
        ...
        <span class="card-title font-weight-bolder text-dark-75 font-size-h2 mb-0 mt-6 d-block">{{count($posts)}}</span>
        <span class="font-weight-bold text-muted font-size-sm">Toplam Yazı</span>
    </div>
    <!--end::Body-->
</div>
