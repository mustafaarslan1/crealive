    ...
    <div class="card card-custom card-stretch">
      ...
      <div class="card-header py-3">
        ...
        <div class="card-toolbar">
          <a href="{{route('post-add')}}" class="btn btn-success">Yeni Yazı Ekle</a>
        </div>
      </div>
      <!--end::Header-->
      <!--begin::Form-->
          ...
          <table class="table table-striped- table-hover table-checkable" id="posts">
                <thead>
                    <tr>
                        ...
                        <th scope="col">Yazı Kategorisi</th>
        ...
        <'row'<'col-sm-12 col-md-5'i><'col-sm-12 col-md-7 dataTables_pager'lp>>`,
            ...
            columns: [
                ...
                { data: 'id', className:"align-right", name: 'id', orderable: false, "render": function(data, type, row) {
                        var editme = '<a href="{{ route("post-update") }}/'+data+'" class="btn btn btn-icon btn-light btn-hover-primary btn-sm" data-toggle="tooltip" data-theme="light" title="Düzenle"><i class="flaticon2-writing icon-md text-primary"></i></a>&nbsp';

                        var deleteme = '<a href="{{ route("post-delete") }}/'+data+'" class="btn btn-icon btn-light btn-hover-danger btn-sm delete-post" data-toggle="tooltip" data-theme="light" title="Sil"><i class="flaticon2-trash icon-md text-danger"></i></a>';
